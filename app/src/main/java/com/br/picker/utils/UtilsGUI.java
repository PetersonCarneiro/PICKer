...
public class UtilsGUI {
    ...
    public static void ExportAlert(Context context, String msg, DialogInterface.OnClickListener listener){

        AlertDialog.Builder builder = new AlertDialog.Builder(context);

        builder.setTitle("Do you really want to export the Csv ?");
        builder.setIcon(android.R.drawable.ic_dialog_info);
